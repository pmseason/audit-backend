...
class ScrapedJobAgent(BaseModel):
    ...
    is_swe_job: bool = Field(description="Whether the job is a software engineering-focused role like 'Software Engineer' or 'Software Developer'. This excludes product and consulting roles and will mostly be true for positions that have 'Software Engineering' in the title or are directly related to engineering. Do not include loosely related engineering roles like 'Data Engineer' or 'DevOps Engineer'.")
